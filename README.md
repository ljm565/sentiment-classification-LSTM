...
* ### 모델 학습 조건 설정 (config.json)
    ...
    * max_len: 토큰화 된 리뷰 데이터의 최대 길이. 최대 길이가 안될 시 자동으로 최대 길이로 패딩.
    ...
    * early_stop_criterion: validation set의 학습이 최대 accuracy 학습 epoch 대비 설정된 숫자만큼 epoch이 지나도 나아지지 않을경우 학습 조기 종료.
...
* ### Sentiment Classification Attention Score 결과
    * Positive review attention score sample<br>
    <img src="images/pos.jpg" width="80%"><br><br>

    * Negative review attention score sample<br>
    <img src="images/neg.jpg" width="80%"><br><br>
